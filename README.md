...
A similarity-assisted variational autoencoder (saVAE) is a new method that adopts similarity information in the framework of the VAE. If you want to know summarized details, please refer to [`saVAE_overvew.pdf`](https://github.com/GwangWooKim/saVAE/blob/main/saVAE_overview.pdf) in this repository that contains backgrounds, preliminaries, methods, results, and conclusions. The published version is [`here`](https://doi.org/10.1186/s12859-023-05552-1).
...
See [here](https://github.com/GwangWooKim/saVAE/issues/1)
